...
class Agent:
    def __init__(self, enviroment, optimizer):
        ...
        self._action_size = self.enviroment.action_space.n
        ...
        # Build networks
        self.q_network = self._build_compile_model((96, 80, 1))
        self.target_network = self._build_compile_model((96, 80, 1))
...
def undertake_learning(agent):
    ...
    for e in range(0, num_of_episodes):
        ...
        bar = progressbar.ProgressBar(
            maxval=timesteps_per_episode/10,
